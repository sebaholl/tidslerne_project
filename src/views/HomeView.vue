...
<template>
  <main>
    <section
      class="relative min-h-screen flex items-center justify-center px-6 md:px-12 text-center overflow-hidden"
    ...
    >
      ...
      <div class="max-w-4xl z-10">
        <h1 class="text-4xl md:text-5xl font-bold text-primary mb-8">Welcome to Tidslerne</h1>
        <p class="text-lg md:text-xl text-gray-700 mb-6">
          A supportive community for cancer patients and their families. Learn, connect, and grow
          together.
        </p>
        <router-link
          to="/join"
    ...
    <section class="relative py-16 px-6 md:px-12" aria-label="Upcoming events">
      <div class="max-w-6xl mx-auto">
        ...
        <div class="relative">
          ...
          <div
            ref="carouselRef"
            class="flex overflow-x-auto gap-4 scroll-smooth snap-x snap-mandatory px-8"
          >
    ...
    <section class="bg-white py-16 px-6 md:px-12 text-center">
      ...
      <p class="text-gray-600 mb-6 max-w-xl mx-auto">
        Stay informed about upcoming events, inspiring articles, and community updates from
        Tidslerne.
      </p>
      <form
    ...
    <!-- CTA Section -->
    <section
      class="bg-[var(--color-primary)] text-white py-16 px-6 md:px-12 text-center"
      aria-label="Call to action"
    >
      <div class="max-w-3xl mx-auto">
        <h2 class="text-3xl md:text-4xl font-bold mb-4">Join Our Supportive Community</h2>
        <p class="text-lg mb-6">
          Become a member of Tidslerne and access valuable knowledge, events, and shared
          experiences.
        </p>
        <router-link
          to="/join"
    ...
    <section class="py-16 px-6 md:px-12 text-center" aria-label="Video library">
      <div class="max-w-5xl mx-auto">
        <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-6">
          Mai Nielsen’s Story & Future Video Library
        </h2>
        <p class="text-lg text-gray-700 mb-10">
          In this special video, our Chairwoman <strong>Mai Nielsen</strong> shares her personal
          journey with cancer and her dedication to the Tidslerne community. This is the first of
          many real stories we aim to showcase in our upcoming video library.
        </p>
        ...
        <blockquote class="italic text-gray-600 max-w-xl mx-auto">
          “By sharing our stories, we empower each other to heal and connect. Tidslerne is here to
