  ...
  <header class="fixed top-0 left-0 w-full bg-white shadow z-50" role="banner">
    ...
    >
      <div class="flex items-center justify-between w-full">
        <!-- Logo -->
        <router-link to="/" class="flex items-center" aria-label="Go to homepage">
          <span class="sr-only">Tidslerne homepage</span>
          <img src="@/images/LogoNew1.svg" alt="Tidslerne logo" class="h-50 w-auto" />
        </router-link>
        ...
        <div class="hidden md:flex gap-x-6 items-center text-xl">
          ...
          <router-link
            ...
            class="relative px-3 py-2 text-gray-700 hover:text-[var(--color-primary)] transition font-medium after:absolute after:left-0 after:bottom-0 after:w-0 hover:after:w-full after:h-[2px] after:bg-[var(--color-primary)] after:transition-all after:duration-300"
          >
            Members
          </router-link>
    ...
    <div
      v-if="isOpen"
      class="md:hidden px-4 pb-4 bg-white shadow space-y-2"
      role="menu"
