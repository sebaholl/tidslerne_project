<template>
  <div class="max-w-6xl mx-auto py-20 px-6">
    <!-- Přihlášený uživatel -->
    <section v-if="isLoggedIn" aria-label="Premium Content mt-20">
      ...
      <article class="grid md:grid-cols-2 gap-8 mb-16" aria-label="Exclusive Interview and Events">
        <section class="bg-white p-6 rounded-xl shadow" aria-labelledby="interview-heading">
          <h2
            ...
            class="text-2xl font-semibold text-[var(--color-primary)] mb-4"
          >
            Exclusive Interview
          </h2>
          <iframe
        ...
        <section class="bg-white p-6 rounded-xl shadow" aria-labelledby="events-heading">
          <h2 id="events-heading" class="text-2xl font-semibold text-[var(--color-primary)] mb-4">
            Upcoming Premium Events
          </h2>
          <ul class="text-gray-700 space-y-2">
            <li>
              <font-awesome-icon icon="star" class="text-[var(--color-primary)] mr-2" /><strong
                >Online Q&A with Doctors</strong
              >
              – June 15
            </li>
            <li>
              <font-awesome-icon icon="video" class="text-[var(--color-primary)] mr-2" /><strong
                >Webinar: Healing Journeys</strong
              >
              – July 10
            </li>
            <li>
              <font-awesome-icon icon="book" class="text-[var(--color-primary)] mr-2" /><strong
                >Virtual Group Discussion</strong
              >
              – July 22
            </li>
            <li>
              <font-awesome-icon icon="comments" class="text-[var(--color-primary)] mr-2" /><strong
                >Live Session with Survivors</strong
              >
              – August 1
            </li>
          </ul>
      ...
      <section class="bg-white p-6 rounded-xl shadow mb-16" aria-labelledby="articles-heading">
        <h2 id="articles-heading" class="text-2xl font-semibold text-[var(--color-primary)] mb-4">
          Featured Articles
        </h2>
        <article class="space-y-6">
          <div>
            ...
            <p class="text-gray-600 mb-2">
              Insights from experts about healing and nutrition during treatment.
            </p>
            <a href="#" class="text-[var(--color-primary)] font-semibold hover:underline"
              >Read More<span class="sr-only"> about Nutrition & Recovery</span> →</a
            >
          </div>
          <div>
            <h3 class="text-lg font-bold text-gray-800">Managing Stress After Diagnosis</h3>
            <p class="text-gray-600 mb-2">
              Tips and community stories on mental health and emotional balance.
            </p>
            <a href="#" class="text-[var(--color-primary)] font-semibold hover:underline"
              >Read More<span class="sr-only"> about Managing Stress</span> →</a
            >
          </div>
        </article>
      </section>
      ...
      <section class="bg-white p-6 rounded-xl shadow mb-16" aria-labelledby="resources-heading">
        <h2 id="resources-heading" class="text-2xl font-semibold text-[var(--color-primary)] mb-4">
          Exclusive Resources
        </h2>
        <ul class="space-y-3">
          <li>
      ...
      <footer class="text-center mt-12" aria-label="Thank you message">
        <p class="text-gray-600 italic">
          Thank you for being part of our premium community. Your membership helps us support even
          more people on their journey.
        </p>
      </footer>
    </section>
    ...
    >
      ...
      <p class="text-gray-600 mb-6">
        This area is reserved for premium members. Please log in or register to access exclusive
        content.
      </p>
